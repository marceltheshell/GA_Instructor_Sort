  ...
  app.directive('currentWeather', function() {
    return {
      ...
      controller: ['$scope', '$http',
        function ($scope, $http) {
          var url = "http://api.openweathermap.org/data/2.5/weather?mode=json&cnt=7&units=imperial&callback=JSON_CALLBACK&APPID=0fc4479619874a7f6cdba46c4945b203&q=san+francisco"
